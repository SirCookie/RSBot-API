...
public class Bank {
	public static final int[] BANK_NPC_IDS = new int[]{
			...
			5257, 5258, 5259, 5260, 5488, 5776, 5777, 5901, 6200, 6362, 7049, 7050, 7605, 8948, 9710, 13932, 14707, 14923,
			14924, 14925, 15194
	};
	...
	private static boolean isBanker(final Identifiable identifiable) {
		...
		return Arrays.binarySearch(BANK_NPC_IDS, identifiable.getId()) >= 0;
	}
